...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:erdosproblems-711",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "erdosproblems:711",
    ...
    "statement": {
      "language": "en",
      "text": "Draft bounty intake target(s): Erdős Problem #711. The exact mathematical statement, quantifiers, definitions, assumptions, and acceptance conditions have not yet been frozen; this draft is not research-admitted.",
      "version": 1
    },
    "title": "Erdős Problem #711",
    "updated_at": "2026-09-08T08:24:29Z"
  },
  "problem_contract_sha256": "0baa560f2829a82a8dfda7d9439f01db246f8a293a894764b2b0f2d2e039f1e7"
}
```
